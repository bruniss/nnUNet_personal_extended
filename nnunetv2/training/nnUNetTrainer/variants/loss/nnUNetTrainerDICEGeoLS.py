...
from nnunetv2.training.loss.geodisiclabelsmoothing import CELossWithGeoLS
from nnunetv2.training.loss.compound_losses import DC_and_Focal_loss
from nnunetv2.training.loss.dice import SoftDiceLoss, MemoryEfficientSoftDiceLoss
import numpy as np

# CURRENTLY THIS ONLY SUPPORTS 1 CLASS, I HAVE NOT YET WORKED OUT MULTICLASS
# i had some issues with a package version i resolved by symlinking the system one like this
# cd ~/miniconda/envs/models/lib
...
class nnUNetTrainerDistDiceLoss(nnUNetTrainer):
    ...
    def get_dataloaders(self):
        ...
        if dim == 2:
            print(
                "Distance transforms for 2D images has not been implemented yet. Will default to regular 2D DataLoaders for now.")
